 ...
 * each grew their own copy of "close on outside click + Escape + render an
 * absolutely-positioned panel with inset rounded items". This module owns
 * that pattern in one place so the menu chrome stays visually consistent
 * (padding, dividers, hover rounding) wherever it's used.
 *
 * Public surface:
 *
 ...
 *  - {@link MenuPanel} — the absolutely-positioned popover shell. Has the
 *    padded "inset items" look so item hovers never touch the panel border.
