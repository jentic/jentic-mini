...
- `registration_client_uri` is the RFC 7592 client configuration endpoint for this agent — used for `GET` (read), `PUT` (update/key rotation), and `DELETE` (self-removal).
