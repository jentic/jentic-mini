...
```bash
curl -X POST https://jpe.home.seanblanchfield.com/jpe.home.seanblanchfield.com/workflows/summarise-latest-topics \
...
**Capability ID:** `POST/jpe.home.seanblanchfield.com/workflows/summarise-latest-topics`
...
**Proper solution (not yet built):** A custom Arazzo extension for transformation steps, or a JPE-provided `transform` pseudo-operation at `/jpe.home.seanblanchfield.com/transform` that accepts data + a jq/JSONPath filter and returns the result.
...
- `GET /inspect/POST/jpe.home.seanblanchfield.com/workflows/{slug}` — inspect
...
```http
GET /inspect/POST/jpe.home.seanblanchfield.com/workflows/summarise-latest-topics
...
```json
{
  "id": "POST/jpe.home.seanblanchfield.com/workflows/summarise-latest-topics",
  "type": "workflow",
  ...
  "_links": {
    "execute": "/jpe.home.seanblanchfield.com/workflows/summarise-latest-topics"
  }
}
```
